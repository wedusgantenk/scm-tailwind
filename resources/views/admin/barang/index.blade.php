...
<div class="w-full px-6 py-6 mx-auto">
  ...
  <div class="flex flex-wrap -mx-3">
    <div class="flex-none w-full max-w-full px-3">
      <div
        class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-solid shadow-soft-xl rounded-2xl bg-clip-border">
        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
          <h6>Barang</h6>
        </div>
        <div class="flex pl-6 py-2 space-x-4 col-md-4">
          <div class="mr-2">
        ...
        <div class="flex-auto px-0 pt-0 pb-2">
          <div class="p-0 overflow-x-auto">
            <table
              class="px-6 py-3 table-auto items-center w-full mb-0 align-top border-transparent border-gray-200 text-slate-600">
              ...
              <tbody class="px-6 py-3 font-semibold text-left text-xs border-spacing-4">
                ...
                <tr>
                  <td
                    class="w-16 text-center text-sm p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    {{ $loop->iteration }}. </td>
                  <td
                ...
                @empty
                <tr>
                  <th colspan="3" class="p-2 text-center bg-transparent border-b whitespace-nowrap shadow-transparent">
                    Tidak ada data</th>
                </tr>
                @endforelse
              </tbody>
