            ...
            <table class="px-6 py-3 table-auto items-center w-full mb-0 align-top border-transparent border-gray-200 text-slate-600">
              <thead class="align-bottom">
                <tr>
                  ...
                  <th class="font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xs border-b-solid tracking-none whitespace-nowrap">Cluster</th>
              ...
              <tbody class="px-6 py-3 font-semibold text-left text-xs border-spacing-4">
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.transaksi.distribusi_depo.detail', $d->id) }}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                  </td>
                </tr>
                @empty
                <tr>
