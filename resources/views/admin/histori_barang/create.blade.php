    ...
    <div class="flex-none w-full max-w-full px-3">
      <div
        ...
        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
          <h6 class="text-s font-bold">Tambah Histori Barang</h6>
        </div>
        <div class="pb-6 pr-6 pl-6 flex-auto">

          <form action="{{ route('admin.histori_barang.store') }}" method="POST" enctype="multipart/form-data" role="form">
            @csrf
            ...
            <div class="mb-4">
              <input type="text"
                ...
                aria-describedby="Histori_barang-addon" autocomplete="off" value="{{ old('kode_unik')}}" name="kode_unik" required>
              @error('kode_unik')
